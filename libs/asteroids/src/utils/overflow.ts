/**
 * Calculates whether the entity is overflowing the canvas horizontally.
 *
 ...
 */
export function isOverflowingX(canvasWidth: number, x: number, width: number) {
...
/**
 * Calculates whether the entity is overflowing the canvas vertically.
 *
